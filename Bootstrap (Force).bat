...
.\engine\BlowoutTeamSoft\Compilation.Module\bin\BCompiler.exe compile_abi --compile-filter "BlowoutTeamSoft.*" --out-directory ".\engine\BlowoutTeamSoft\Sdk\GeneratedNative" --expose-errors true --compilation-mode Force
