...
public partial class GameObject
{
	...
	public T GetComponent<T>( bool includeDisabled = false )
		...
		=> Components.Get<T>( includeDisabled );
	...
	public IEnumerable<T> GetComponents<T>( bool includeDisabled = false )
		where T : IBlowoutGameSystem
		=> Components.GetAll<T>( includeDisabled ? (FindMode.InSelf | FindMode.Enabled | FindMode.Disabled) : FindMode.InSelf | FindMode.Enabled );
