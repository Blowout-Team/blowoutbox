...
public sealed partial class PhysicsBody : IBlowoutPhysicsBody
{
	...
	public Guid Id => _component.Id;

	public BlowoutEngineGameObject SystemGameObject => _component.SystemGameObject;
	...
	public void ForceChangeId( Guid id, bool isRefresh = false ) =>
		_component.ForceChangeId( id, isRefresh );
	...
	public object InstallParentClone( IBlowoutGameSystem gameSystem ) =>
		((IBlowoutGameSystem)_component).InstallParentClone( gameSystem );
